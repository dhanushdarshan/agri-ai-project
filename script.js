...
/* =========================================
   SCREEN NAVIGATION
   Switches between the 4 top-level pages:
   pg-landing → pg-login → pg-setup → pg-dash
========================================= */
function goPage(id) {
...
/* =========================================
   ...
   Swaps the visible .dash-section inside
   pg-dash without changing the outer page.
========================================= */
var sectionTitles = {
  home:     'Farm Overview',
...
/* =========================================
   ...
   Built once when dashboard first opens.
========================================= */
...
function simDisease() {
  ...
  document.getElementById('u-text').textContent = 'Analysing with AI…';
  document.getElementById('u-sub').textContent  = 'Scanning 47 disease patterns…';
  ...
  setTimeout(function () {
    ...
    document.getElementById('u-icon').textContent = '✅';
    document.getElementById('u-text').textContent = 'Analysis complete';
    document.getElementById('u-sub').textContent  = 'Click to scan another image';
  }, 1800);
}
